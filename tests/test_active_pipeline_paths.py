...
def test_default_step_3_paths_match_award_first_layout():
    assert default_classification_path_for_award("MA000018") == PROJECT_ROOT / Path(
        "data/processed/MA000018/2_1_payment_classification.json"
    )
...
def test_interpretation_artifact_paths_match_award_first_layout():
    interpretation_path = Path("data/processed/MA000018/3_1_OT_creation_ruleset.md")
...
def test_resolve_clause_classification_path_uses_ruleset_when_interpretation_is_explicit_ruleset():
    classification_path = Path("data/processed/MA000018/2_1_payment_classification.json")
    interpretation_path = Path("data/processed/MA000018/3_1_OT_consequence_ruleset.md")
