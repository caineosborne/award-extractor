...
| 3 | `src/script_3_interpret_overtime.py` | Intermediate overtime clause classification JSON | `data/processed/3_overtime_interpretations/MAxxxxx_overtime_clause_classification.json`; archive: `data/processed/3_overtime_interpretations/archive/MAxxxxx_overtime_clause_classification_YYYYMMDD_HHMMSS.json` |
| 3 | `src/script_3_interpret_overtime.py` | Expert A overtime interpretation rules JSON and markdown | `data/processed/3_overtime_interpretations/MAxxxxx_overtime_interpretation_expert_a.json`; `data/processed/3_overtime_interpretations/MAxxxxx_overtime_interpretation_expert_a.md`; archives in `data/processed/3_overtime_interpretations/archive/` |
| 3 | `src/script_3_interpret_overtime.py` | Expert B overtime interpretation rules JSON and markdown | `data/processed/3_overtime_interpretations/MAxxxxx_overtime_interpretation_expert_b.json`; `data/processed/3_overtime_interpretations/MAxxxxx_overtime_interpretation_expert_b.md`; archives in `data/processed/3_overtime_interpretations/archive/` |
| 3 | `src/script_3_interpret_overtime.py` | Expert comparison and merge artifact | `data/processed/3_overtime_interpretations/MAxxxxx_overtime_interpretation_comparison.json`; archive in `data/processed/3_overtime_interpretations/archive/` |
| 3 | `src/script_3_interpret_overtime.py` | Canonical merged overtime interpretation rules JSON and markdown working document | `data/processed/3_overtime_interpretations/MAxxxxx_overtime_interpretation.json`; `data/processed/3_overtime_interpretations/MAxxxxx_overtime_interpretation.md`; archives in `data/processed/3_overtime_interpretations/archive/` |
...
| 3B evaluator | `evaluation_system_prompt()` in `src/script_3b_shared_prompts.py` |
| 3B creator update | `src/script_3_interpret_overtime_prompt.py` |
| 3B agentic review | `src/script_3b_agentic_review_workflow.py` with creator and evaluator prompts from `src/script_3b_shared_prompts.py` |
